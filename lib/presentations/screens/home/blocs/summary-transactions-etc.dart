...
class SummaryTransactionsEtcBloc implements BaseBloc {
  ...
  SummaryTransactionsEtcBloc({@required this.reportService}) {
  ...
  Future<void> fetchAmountTransactions() async {
    try {
      ...
      double amount =
          await reportService.getSummaryTransactionsEtc(startAt, endAt);
